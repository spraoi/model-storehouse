...
#     "blank_header_20"]
# # columns = []
# print(predict(model_name="model_ffm",artifacts=["p2_tokenizer_BERT_WP.joblib"],model_path="phase_two_model.h5",inputs={"datasetId":"spr:dataset_id","columns":columns}))
